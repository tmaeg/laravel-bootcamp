    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                ...
                <Dropdown v-if="chirp.user.id === $page.props.auth.user.id" class="">
                    <template #trigger>
                        <button>
                    ...
                    <template #content>
                        ...
                        <DropdownLink as="button" :href="route('chirps.destroy', chirp)" method="delete">
                            Delete
                        </DropdownLink>
                    </template>
                </Dropdown>
            ...
            <form v-if="editing" @submit.prevent="form.put(route('chirps.update', chirp.id), { onSuccess: () => editing = false })">
                <textarea v-model="form.message" class="mt-4 w-full text-gray-900 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-small"></textarea>
